vkAuth <- function(client_id = NULL, client_secret = NULL, apiVersion = "5.68"){
  #Получаем code
  browseURL(paste0("https://oauth.vk.com/authorize?client_id=",client_id,"&redirect_uri=https://oauth.vk.com/blank.html&display=popup&scope=offline,groups,ads,stats&response_type=code&v=",apiVersion))
