vkAuth <- function(app_id = NULL, app_secret = NULL, apiVersion = "5.68"){
  #Ïîëó÷àåì code
  browseURL(paste0("https://oauth.vk.com/authorize?client_id=",app_id,"&redirect_uri=https://selesnow.github.io/rvkstat/getCode/get_code.html&display=popup&scope=offline,groups,ads,stats,messages&response_type=code&v=",apiVersion))
