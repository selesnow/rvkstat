vkAuth <- function(app_id = NULL, app_secret = NULL, apiVersion = "5.68"){
  ...
  #Ïîëó÷àåì òîêåí
  token <- GET(paste0("https://oauth.vk.com/access_token?client_id=",app_id,"&client_secret=",app_secret,"&https://selesnow.github.io/rvkstat/getCode/get_code.html&code=",code))
