...
- **[Функции доступные в пакете rvkstat](https://github.com/selesnow/rvkstat/blob/master/README.md#Функции-доступные-в-пакете-rvkstat)**
  - [Функции для загрузки данных из рекламного кабинета Вконтакте](https://github.com/selesnow/rvkstat#Функции-для-загрузки-данных-из-рекламного-кабинета-Вконтакте)
    ...
    - [vkGetAdPostsReach](https://github.com/selesnow/rvkstat/blob/master/README.md#Получить-подробную-статистику-по-охвату-рекламных-записей-из-объявлений-и-кампаний-для-продвижения-записей-сообщества) - Получить подробную статистику по охвату рекламных записей из объявлений и кампаний для продвижения записей сообщества
